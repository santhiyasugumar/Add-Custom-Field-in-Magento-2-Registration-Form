...
*/
class AddStateAttribute implements DataPatchInterface, PatchRevertableInterface
{
   /**
   ...
   public function addCustomerAttribute()
   {
       ...
       $eavSetup->addAttribute(
           ...
           [
               ...
               'source' => 'Vendorname\Customer\Model\Source\StateOptions',
           ]
       );
       ...
       $attribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'stateid');
