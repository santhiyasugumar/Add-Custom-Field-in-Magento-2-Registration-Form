...
*/
class AddCustomStateAttribute implements DataPatchInterface, PatchRevertableInterface
{
   /**
   ...
   public function addCustomerAttribute()
   {
       ...
       $attribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'custom_state');
