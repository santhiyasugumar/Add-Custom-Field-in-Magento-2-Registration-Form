...
*/
class AddSAPCustomerCodeAttribute implements DataPatchInterface, PatchRevertableInterface
{
   /**
   ...
   public function addCustomerAttribute()
   {
       ...
       $attribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'sap_customer_code');
