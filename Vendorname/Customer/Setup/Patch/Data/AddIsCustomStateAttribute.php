...
*/
class AddIsCustomStateAttribute implements DataPatchInterface, PatchRevertableInterface
{
   /**
   ...
   public function addCustomerAttribute()
   {
       ...
       $attribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'is_custom_state');
