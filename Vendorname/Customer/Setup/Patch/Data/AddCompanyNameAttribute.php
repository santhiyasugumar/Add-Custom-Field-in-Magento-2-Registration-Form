...
*/
class AddCompanyNameAttribute implements DataPatchInterface, PatchRevertableInterface
{
   /**
   ...
   public function addCustomerAttribute()
   {
       ...
       $attribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'company_name');
