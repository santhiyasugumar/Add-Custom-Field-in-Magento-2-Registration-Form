...
*/
class AddCountryAttribute implements DataPatchInterface, PatchRevertableInterface
{
   /**
   ...
   public function addCustomerAttribute()
   {
       ...
       $eavSetup->addAttribute(
           ...
           [
               ...
               'source' => 'Vendorname\Customer\Model\Source\CountryOptions',
           ]
       );
       ...
       $attribute = $this->eavConfig->getAttribute(Customer::ENTITY, 'countryid');
